...
INSERT INTO "new_Exercise" ("category", "createdAt", "equipment", "id", "muscleGroup", "name", "parentId", "updatedAt", "userId") SELECT "category", "createdAt", "equipment", "id", "muscleGroup", "name", "parentId", "updatedAt", "userId" FROM "Exercise";
DROP TABLE "Exercise";
